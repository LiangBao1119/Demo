...
public class Message_Output_Json {
    ...
    public static boolean createJsonFile(/*ArrayList<String> Array_Msg*/ String [][] Array
...
//            	jsonString = Array.get(i);
            	jsonString_Name = Array [0][i];
            	jsonString_Cus_Name = Array [1][i];
            	jsonString_Msg = Array [2][i];
...
//                jsonString_Msg = jsonString.substring(0,jsonString.indexOf(","));
//                System.out.println(jsonString_Msg);
//                jsonString_Name = jsonString.substring(jsonString.indexOf(",")+1,jsonString.indexOf(","));
//                System.out.println(jsonString_Name);
//                jsonString_Cus_Name = jsonString.substring(jsonString.indexOf(",")+1);
